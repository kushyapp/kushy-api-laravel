...
class ShippingItemsControllerTest extends CrudTest
{
    /**
     ...
     * @var class
     */
    protected $model = \KushyApi\ShippingItems::class;
     ...
     * @var string
     */
    protected $endpoint = 'manifestos/items';
